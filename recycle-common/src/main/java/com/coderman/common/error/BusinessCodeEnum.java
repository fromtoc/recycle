 ...
 * 業務錯誤碼：返回结果的狀態碼
 *
 * 如果想要代碼更具维护性一點,可以定义不同种類的錯誤碼,都实现 BaseCodeInterface
 * @Author zhangyukang
 * @Date 2020/3/1 14:51
 * @Version 1.0
 **/
...
public enum  BusinessCodeEnum implements BaseError {
    ...
    //業務異常
    PRODUCT_IS_REMOVE(30001,"物資已移入回收站"),
    PRODUCT_NOT_FOUND(30002,"物資找不到"),
    PRODUCT_WAIT_PASS(30003,"物資等待审核"),
    PRODUCT_STATUS_ERROR(30004,"物資狀態錯誤"),
    PRODUCT_IN_STOCK_NUMBER_ERROR(30005,"物資入库数量非法"),
    PRODUCT_OUT_STOCK_NUMBER_ERROR(30008,"物資发放数量非法"),
    PRODUCT_IN_STOCK_EMPTY(30006,"物資入库不能为空"),
    PRODUCT_OUT_STOCK_EMPTY(30007,"物資发放不能为空"),
    PRODUCT_STOCK_ERROR(30009,"物資库存不足");
    /** 錯誤碼 */
